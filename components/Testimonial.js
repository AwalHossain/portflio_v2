  ...
  return (
    <div className="w-full bg-bluegray-light py-20 px-5 flex flex-col items-center justify-center flex-shrink-0">
      <p className="text-xl md:text-3xl text-center max-w-4xl">
        "Awal is quick to iterate on feedback and has a knack for understanding
        the genre you expect in design. I would highly recommend him to anyone
        who is looking to build a great website."
      </p>
